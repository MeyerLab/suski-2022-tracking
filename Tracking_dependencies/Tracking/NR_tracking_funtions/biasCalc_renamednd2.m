function biasCalc_renamed(s,debug)
%Calculate bias based on renamed Nikon files (naming convention from IXM)
%{row}_{col}_{site}\{row}_{col}_{site}_{channel}_{timepoint}.tif
%%% file paths %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
imagepath=s.imagepath;
shadingpath=s.shadingpath;
experimentpath=s.experimentpath;
Biasdir=[experimentpath,'Bias'];
%%% setup %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if ~isempty(shadingpath)
    ...
    rawdir = [experimentpath,imagepath,shot,'\',shot,'_'];
    tempim = double(imread([rawdir,names{1},'_',num2str(frame_mat(1)),'.tif']));
