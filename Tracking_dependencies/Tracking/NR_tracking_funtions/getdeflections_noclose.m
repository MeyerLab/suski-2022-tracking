function vIdx=getdeflections_noclose(orderedset,nucr)
...
%debug
%quiver(orderedset(:,1),orderedset(:,2),shortdiff(:,1),shortdiff(:,2))
...
%%%%%%% short steps %%%%%%%%%%%%%%%%%%
%debug
%scatter(orderedset(:,1),orderedset(:,2),[],(shortgraddiff))
shortgraddiff(shortgraddiff>=pi)=0;  %exclude
vIdxmaskshort=shortgraddiff>shortgradthresh;
%%%%%%% long steps %%%%%%%%%%%%%%%%%%%
%debug
%scatter(orderedset(:,1),orderedset(:,2),[],(longgraddiff))
