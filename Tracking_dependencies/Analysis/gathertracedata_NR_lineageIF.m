function [tracedata,tracestats,motherstats,IFdata,jitters,samplecellsID,ismother, allIFdata,linkedIFdata]=gathertracedata_NR_lineageIF(datadir,shot,motheroption,daughteroption,IFoption, IFlabel)
%%% Load Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% Propagate gate through lineage %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[linkedIFdata, gateIFMother] = linkIFdata(tracestats,samplecellsID,IFdata,gateIF);
samplecells=gategenealogy & (gateIF | gateIFMother);
samplecellsID=find(samplecells);
...
linkedIFdata = linkedIFdata(samplecells,:);
samplecellsID;
end
