function [tracedata,tracestats,motherstats,IFdata,jitters,samplecellsID,genealogy,isMother]=gathertracedata_1_rev05_NR_mother(datadir,shot,motheroption,daughteroption,IFoption, IFlabel)
%%% Load Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
isMother(mothers) = true;
isMother = isMother(samplecells);
samplecellsID;
end
