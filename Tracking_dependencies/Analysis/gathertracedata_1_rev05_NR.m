function [tracedata,tracestats,motherstats,IFdata,jitters,samplecellsID,genealogy]=gathertracedata_1_rev05_NR(datadir,shot,motheroption,daughteroption,IFoption, IFlabel)
%%% Load Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
allIFdata = IFdata;
unmatched = any(isnan(allIFdata),2);
allIFdata(unmatched,:) = [];
