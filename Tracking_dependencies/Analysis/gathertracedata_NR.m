function [tracedata,tracestats,motherstats,IFdata,jitters,samplecellsID,ismother, allIFdata]=gathertracedata_NR(datadir,shot,motheroption,daughteroption,IFoption, IFlabel)
%%% Load Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
