...
%%% Paths
s.experiment_name='C176-3i-live';
s.savepath=['F:\Data\C-Cdt1\',s.experiment_name,'\Data\'];
s.imagepath=['F:\Data\3i Data\PCNA 45\C176-3i-ind\Raw\'];
s.maskpath=['F:\Data\3i Data\PCNA 45\C176-3i-ind\Mask\'];

%%% General parameters
s.startFrame=1;   %Frame to start analyzing from
s.endFrame=63;  %Frame to stop analyzing
