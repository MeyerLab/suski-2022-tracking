...
%%% Paths
settings.data_path = 'F:\Data\C-Cdt1\C191-total-IF\Data\';
settings.IF_imagesessions = {'J:\Data\C191-total-IF2\', 'J:\Data\C191-total-IF1\'};
settings.bgcmospath = 'F:\MATLAB\BGimages\IX_Liu\cmosoffset_bin1.mat';
settings.maskpath = 'J:\Data\C191-IFcrop\';
settings.crop_save = 'J:\Data\C191-IFcrop\';
...
settings.bgsubmethod = {{'global nuclear','global nuclear' ,'global nuclear' }, {'global nuclear','global nuclear', 'global nuclear'}}; %'global nuclear','global cyto','tophat','semi-local nuclear'
...
regheight = 1:settings.regcompress *height;
regwidth = 1:settings.regcompress *width;
jitmatx = [];
jitmaty = [];
if length(names) > 1
    for i = 1:length(names)
