...
%%% Paths
experiment_name='C191-preext-IF';
image_drive = 'D:\4TB10\Data\C191-preext-live\';
savepath=['F:\Data\C-Cdt1\',experiment_name,'\Data\'];
%imagepath=[image_drive,experiment_name,'\Raw\'];
imagepath=[image_drive,'\Raw\'];
biaspath=[image_drive,'\Bias\'];
maskpath=[image_drive,'\Mask\'];
bgcmospath='';

%%% General parameters
liveFrame=1;   %Frame to start analyzing from
